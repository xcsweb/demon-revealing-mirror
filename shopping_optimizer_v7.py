...
def solve():
    ...
    # 尝试优化后的分组策略
    groupings = [
        # 优化分组1：高配床 + 椰棕床垫 + 沙发 + 餐桌凑大单，剩下的床架和儿童床
        [
            ['林氏奶油风实木床(高配,含床垫)', '林氏椰棕床垫', '林氏原木风餐桌', '林氏奶油风沙发'],
            ['林氏实木儿童床(含床垫)', '林氏实木床1.8m标配(仅床架)']
        ],
        # 优化分组2：高配床 + 椰棕床垫 + 儿童床，沙发 + 餐桌 + 床架
        [
            ['林氏奶油风实木床(高配,含床垫)', '林氏椰棕床垫', '林氏实木儿童床(含床垫)'],
            ['林氏奶油风沙发', '林氏原木风餐桌', '林氏实木床1.8m标配(仅床架)']
        ],
        # 优化分组3：高配床 + 椰棕床垫 + 沙发 + 床架 + 餐桌凑一张最大的单，儿童床单独
        [
            ['林氏奶油风实木床(高配,含床垫)', '林氏椰棕床垫', '林氏奶油风沙发', '林氏实木床1.8m标配(仅床架)', '林氏原木风餐桌'],
            ['林氏实木儿童床(含床垫)']
        ]
    ]
