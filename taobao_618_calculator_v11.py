...
def calc_gov_subsidy(products):
    ...
    """
    total_subsidy = 0
    eligible_products = []  # Returns list of (product_name, rate, subsidy)
...
def solve():
    ...
    print("=" * 75)
    print("淘宝618购物车最优购买方案计算器 v11（最终修正版）")
    print("=" * 75)
    print("\n✅ 已核实政策数据：")
